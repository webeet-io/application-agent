...
- Backend-3 must stay within its assigned task or file scope.
- Backend-3 must not overwrite or revert work owned by another backend instance.
- If Backend-3 encounters overlap or conflicting edits, it must stop and escalate the collision instead of resolving it silently.
